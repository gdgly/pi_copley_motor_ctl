...
//					motor_speed_t = deltav_force*pndex + index*integral_force*0;
					printf("what is integral_force : %d\n",integral_force);
...
//
//					}										
					printf("%u motor_speed_t = %d deltav_force = %d \n",time_now,motor_speed_t,deltav_force);
					break;
